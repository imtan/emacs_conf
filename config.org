...
#+RESULTS:
| org-roam-ui-mode | vertico-multiform-mode | org-persist-load-all | dashboard-insert-startupify-lists | #[0 \300\301!\210\302\303!\207 [mouse-wheel-mode 0 mac-mouse-wheel-mode 1] 2] | #[0 \301\236A@\211\205 \302\303"?\262\205  \304\305 !\306=\205  \307\305 !\207 [mac-startup-options command-line string-match \`-psn_ frame-visible-p selected-frame t x-focus-frame] 4] | mac-process-deferred-apple-events | tramp-register-archive-autoload-file-name-handler | (lambda nil (when (and (symbol-value 'init-file-user) skk-preload) (skk-preload) (message SKK preload...done)) (when window-system (ccc-setup))) | #[nil \302J\203 \203 \300 \210\303\304!\210	\205 \305 \207 [skk-preload window-system init-file-user message SKK preload...done ccc-setup] 2] | magit-maybe-define-global-key-bindings |
